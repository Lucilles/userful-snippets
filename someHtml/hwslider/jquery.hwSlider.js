    ...
    HwSlider.prototype = {
        init: function () {
            ...
            if (self.options.arrShow) {
                var arrElement = '<a href="javascript:;" class="arr prev"><i class="icon-angle-left"></i></a><a href="javascript:;" class="arr next"><i class="icon-angle-right"></i></a>';
                if (hwsliderSize > 1) {
            ...
            var resize = function () {
                ...
                if (self.options.dotShow) {
                    ...
                    ele.find(".dots").css('left', dotOffset - 100 + 'px'); //导航圆点位置
                }
            }
